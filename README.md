...
| `background-opacity` | `0.95` | 微透明增加层次感，不损文字对比度；⚠️ 低于 0.9 会导致对话区域背景与主题色偏差过大 / Subtle depth without compromising contrast; ⚠️ values below 0.9 cause significant background color divergence |
